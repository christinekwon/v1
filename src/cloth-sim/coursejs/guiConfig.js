...
GuiConfig.dropdownOptions.grounds = [
  "grass-big.jpg",
  "grass-thin.jpg",
  "metal.jpg",
  "noise.jpg",
...
GuiConfig.defs = [
   ...
   ***************************************************/
   ...
   },
   {
     folderName: "Appearance",
     name: "cloth img",    
     dropdownOptions: GuiConfig.dropdownOptions.textures,
     defaultOption: GuiConfig.dropdownOptions.textures[1],
     param: "clothTexture",
     onChange: Scene.update,
   },
   {
   ...
   },
   {
     folderName: "Appearance",
     name: "ground img",
     dropdownOptions: GuiConfig.dropdownOptions.grounds,
     defaultOption: GuiConfig.dropdownOptions.grounds[0],
     param: "groundTexture",
     onChange: Scene.update,
   },
   /***************************************************
