class Params {
  ...
  constructor() {
    ...
    // ====================================================================
    this.integrate = true; // Should verlet integration be applied?
    ...
    this.object = "Sphere"; // Which object is present in the scene
    ...
    this.rotate = true;    // Should the camera auto-rotate?

    this.clothColor = 0xa24318c;     // base color of cloth
    this.clothSpecular = 0x592121;  // reflection color of cloth

    this.groundColor = 0x48370e;    // base color of ground
    // this.groundSpecular = 0x404761; // reflection color of ground
    this.groundEmissive = 0xa07f7f; // emission color of ground

    this.fogColor = 0xffb9d9;       // base color of fog
    ...
    this.clothTexture = "bubbles.png";

    this.showGroundTexture = false;
    this.groundTexture = "grass-big.jpg";
